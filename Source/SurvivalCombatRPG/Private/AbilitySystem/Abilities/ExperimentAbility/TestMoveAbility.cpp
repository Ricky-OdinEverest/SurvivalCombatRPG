...
#include "AbilitySystem/Abilities/ExperimentAbility/TestMoveAbility.h"

#include "AbilitySystemComponent.h"
#include "AbilitySystemLog.h"

void UTestMoveAbility::ActivateAbility(const FGameplayAbilitySpecHandle Handle,
...
void UTestMoveAbility::EndAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo,
...
ASCR_PlayerCharacter* UTestMoveAbility::GetPlayerCharacterFromActorInfo() const
{
	return Cast<ASCR_PlayerCharacter>(GetAvatarActorFromActorInfo());
}
