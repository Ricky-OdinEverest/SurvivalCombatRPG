...
public:
	...
	ATTRIBUTE_ACCESSORS(USCR_AttributeSet, Resilience);

	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_Vigor, Category = "Primary Attributes")
	FGameplayAttributeData Vigor;
	ATTRIBUTE_ACCESSORS(USCR_AttributeSet, Vigor);
	...
	ATTRIBUTE_ACCESSORS(USCR_AttributeSet, BlockChance);
	...
	ATTRIBUTE_ACCESSORS(USCR_AttributeSet, Health);

	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_MaxHealth, Category = "Vital Attributes")
	FGameplayAttributeData MaxHealth;
	ATTRIBUTE_ACCESSORS(USCR_AttributeSet, MaxHealth);
