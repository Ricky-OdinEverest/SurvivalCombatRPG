...
#include "SCR_CosmeticAnimationTypes.generated.h"
...
struct FSCR_AnimLayerSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FSCR_AnimLayerSelectionSet
{
	GENERATED_BODY()
	...
	TArray<FSCR_AnimLayerSelectionEntry> LayerRules;
...
USTRUCT(BlueprintType)
struct FSCR_AnimBodyStyleSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FSCR_AnimBodyStyleSelectionSet
{
	GENERATED_BODY()
		
	// List of layer rules to apply, first one that matches will be used
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(TitleProperty=Mesh))
	TArray<FSCR_AnimBodyStyleSelectionEntry> MeshRules;
