...
#include "SCR_CharacterPartTypes.generated.h"
...
struct FSCR_CharacterPartHandle
{
	GENERATED_BODY()
...
struct FSCR_CharacterPart
{
	...
	static bool AreEquivalentParts(const FSCR_CharacterPart& A, const FSCR_CharacterPart& B)
	{
